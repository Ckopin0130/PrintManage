...
const Settings = ({ 
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-24 p-6 font-sans">
       <h2 className="text-2xl font-extrabold text-slate-800 mb-6 tracking-wide">系統設定</h2>
       
       {/* 資料庫狀態 */}
       <div className="bg-white p-5 rounded-2xl shadow-[0_2px_8px_rgb(0,0,0,0.04)] border border-slate-100 mb-5">
       ...
       {/* 雲端還原中心 */}
       <div className="bg-white p-5 rounded-2xl shadow-[0_2px_8px_rgb(0,0,0,0.04)] border border-blue-100 mb-5 relative overflow-hidden">
       ...
       {/* 危險區域 */}
       <div className="bg-white p-5 rounded-2xl shadow-[0_2px_8px_rgb(0,0,0,0.04)] border border-rose-100 mb-6">
          <h3 className="font-bold text-slate-700 mb-4 flex items-center pb-2 border-b border-slate-50">
       ...
       <div className="text-center text-[10px] font-bold text-slate-300 tracking-widest mt-8">SYSTEM V11.20</div>
   </div>
  );
};
